...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Array of active categories, ordered by displayOrder then name.', schema: { type: 'array', items: api_responses_1.CategorySchema } }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Category object.', schema: api_responses_1.CategorySchema }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Category created.', schema: api_responses_1.CategorySchema }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Updated category object.', schema: api_responses_1.CategorySchema }),
    (0, swagger_1.ApiResponse)(api_responses_1.R400),
    (0, swagger_1.ApiResponse)(api_responses_1.R401),
    (0, swagger_1.ApiResponse)(api_responses_1.R403),
    (0, swagger_1.ApiResponse)(api_responses_1.R404),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Category deactivated (isActive set to false). Hard delete is not performed.', ...api_responses_1.SuccessResponse }),
    (0, swagger_1.ApiResponse)({ status: 409, description: 'Cannot deactivate — category has active subcategories. Deactivate subcategories first.', ...api_responses_1.R409 }),
    (0, swagger_1.ApiResponse)(api_responses_1.R401),
    (0, swagger_1.ApiResponse)(api_responses_1.R403),
    (0, swagger_1.ApiResponse)(api_responses_1.R404),
    (0, require_permissions_decorator_1.RequirePermissions)(permission_enum_1.Permission.CATEGORY_MANAGE),
