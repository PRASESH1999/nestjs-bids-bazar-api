...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'All categories (active + inactive when includeInactive=true).', schema: { type: 'array', items: api_responses_1.CategorySchema } }),
...
__decorate([
    ...
    (0, swagger_1.ApiQuery)({ name: 'includeInactive', required: false, type: Boolean }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'All subcategories (active + inactive when includeInactive=true). Filter by categoryId to get subcategories for a specific parent.', schema: { type: 'array', items: api_responses_1.SubcategorySchema } }),
    (0, swagger_1.ApiResponse)(api_responses_1.R401),
    (0, swagger_1.ApiResponse)(api_responses_1.R403),
    (0, require_permissions_decorator_1.RequirePermissions)(permission_enum_1.Permission.CATEGORY_MANAGE),
