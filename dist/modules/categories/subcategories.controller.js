...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Array of active subcategories, ordered by displayOrder then name. Pass ?categoryId to filter by parent.', schema: { type: 'array', items: api_responses_1.SubcategorySchema } }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Subcategory object.', schema: api_responses_1.SubcategorySchema }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Subcategory created.', schema: api_responses_1.SubcategorySchema }),
    (0, swagger_1.ApiResponse)(api_responses_1.R400),
    (0, swagger_1.ApiResponse)(api_responses_1.R401),
    (0, swagger_1.ApiResponse)(api_responses_1.R403),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Parent category not found or inactive.', ...api_responses_1.R404 }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Updated subcategory object.', schema: api_responses_1.SubcategorySchema }),
    (0, swagger_1.ApiResponse)(api_responses_1.R400),
    (0, swagger_1.ApiResponse)(api_responses_1.R401),
    (0, swagger_1.ApiResponse)(api_responses_1.R403),
    (0, swagger_1.ApiResponse)(api_responses_1.R404),
...
__decorate([
    ...
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Soft-delete a subcategory (Admin/SuperAdmin only)' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Subcategory deactivated (isActive set to false).', ...api_responses_1.SuccessResponse }),
    (0, swagger_1.ApiResponse)(api_responses_1.R401),
    (0, swagger_1.ApiResponse)(api_responses_1.R403),
    (0, swagger_1.ApiResponse)(api_responses_1.R404),
    (0, require_permissions_decorator_1.RequirePermissions)(permission_enum_1.Permission.CATEGORY_MANAGE),
