...
exports.paymentWindowExpiringTemplate = paymentWindowExpiringTemplate;
const mail_format_util_1 = require("../utils/mail-format.util");
function paymentWindowExpiringTemplate(params) {
    const { bidderName, productTitle, amount, paymentDeadline, paymentUrl } = params;
    return {
  ...
  <div class="wrapper">
    ...
    <div class="body">
      ...
      <div class="urgent-box">
        ...
        <div class="deadline-value">${(0, mail_format_util_1.formatDateTime)(paymentDeadline)}</div>
      </div>
      <div class="info-box">Amount due: <strong>${(0, mail_format_util_1.formatCurrency)(amount)}</strong></div>
      <p>
...
//# sourceMappingURL=payment-window-expiring.template.js.map