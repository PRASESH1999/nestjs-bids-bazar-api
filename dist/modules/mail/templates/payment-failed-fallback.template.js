...
exports.paymentFailedFallbackTemplate = paymentFailedFallbackTemplate;
const mail_format_util_1 = require("../utils/mail-format.util");
function paymentFailedFallbackTemplate(params) {
    const { bidderName, productTitle, winningAmount, paymentDeadline, fallbackRank, paymentUrl, } = params;
    return {
...
//# sourceMappingURL=payment-failed-fallback.template.js.map