...
exports.auctionWonTemplate = auctionWonTemplate;
const mail_format_util_1 = require("../utils/mail-format.util");
function auctionWonTemplate(params) {
    const { bidderName, productTitle, winningAmount, paymentDeadline, paymentUrl, } = params;
    return {
        subject: 'You won! Pay within 18 hours — BidsBazar',
        html: `
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
  <div class="wrapper">
    ...
    <div class="body">
      ...
      <span class="badge">Auction Won</span>
      <p>You are the winning bidder for <strong>${productTitle}</strong>.</p>
      <div class="info-box">
        <div class="label">Winning Amount</div>
        <div class="value">${(0, mail_format_util_1.formatCurrency)(winningAmount)}</div>
      </div>
      <div class="info-box">
        <div class="label">Payment Deadline</div>
        <div class="value">${(0, mail_format_util_1.formatDateTime)(paymentDeadline)}</div>
      </div>
      <div class="warning-box">
        ⚠️ <strong>Important:</strong> You must complete payment before the deadline above.
        Missing the deadline will forfeit your win and the item will be offered to the next bidder.
      </div>
      <p>Click below to view payment instructions:</p>
...
//# sourceMappingURL=auction-won.template.js.map