...
exports.bidOutbidTemplate = bidOutbidTemplate;
const mail_format_util_1 = require("../utils/mail-format.util");
function bidOutbidTemplate(params) {
    const { bidderName, productTitle, yourBidAmount, newHighestBid, biddingEndsAt, auctionUrl, } = params;
    return {
  ...
  <div class="wrapper">
    ...
    <div class="body">
      ...
      <div class="bid-row">
        ...
        <span class="amount-old">${(0, mail_format_util_1.formatCurrency)(yourBidAmount)}</span>
      </div>
      <div class="bid-row">
        <span class="label">New highest bid</span>
        <span class="amount-new">${(0, mail_format_util_1.formatCurrency)(newHighestBid)}</span>
      </div>
      <div class="deadline">
        ⏰ Bidding closes: <strong>${(0, mail_format_util_1.formatDateTime)(biddingEndsAt)}</strong>
      </div>
...
//# sourceMappingURL=bid-outbid.template.js.map