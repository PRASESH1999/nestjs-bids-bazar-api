...
exports.nameChangedTemplate = nameChangedTemplate;
function nameChangedTemplate(userName, changedAt) {
    return {
        subject: 'Your display name has been changed — BidsBazar',
        html: `
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>Display name changed</title>
  <style>
...
<body>
  <div class="wrapper">
    ...
    <div class="body">
      <p>Hello, ${userName}!</p>
      <p>
        Your display name on BidsBazar was successfully changed on
...
//# sourceMappingURL=name-changed.template.js.map