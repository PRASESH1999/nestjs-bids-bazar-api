...
export class CreateNotificationsTable1788422104447 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."notifications_type_enum" AS ENUM('BID_PLACED_SELLER', 'OUTBID', 'AUCTION_WON', 'AUCTION_CLOSED_SELLER', 'PAYMENT_WINDOW_EXPIRING', 'PAYMENT_FAILED_FALLBACK', 'PAYMENT_FAILED_SELLER', 'AUCTION_ABANDONED', 'PAYMENT_CONFIRMED_SELLER', 'PAYMENT_CONFIRMED_BUYER')`,
    );
    await queryRunner.query(
