...
export class AddProductSettlementAndRenamePayments1789999241844 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "seller_ratings" ADD CONSTRAINT "FK_6f42babf8a7351f3cb827ade2ec" FOREIGN KEY ("paymentId") REFERENCES "payments"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
  }
}
