...
export class RenameProductStatusEnum1789990314613 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."products_status_enum" AS ENUM('DRAFT', 'AWAITING_APPROVAL', 'REJECTED', 'AWAITING_FIRST_BID', 'ACTIVE', 'AWAITING_PAYMENT', 'SETTLED', 'ABANDONED', 'WITHDRAWN')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX "public"."IDX_58075ba759b7738eb2eac5a9af"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_bca32e7e2b877bcaae255805c3"`);
        await queryRunner.query(`CREATE TYPE "public"."products_status_enum_old" AS ENUM('DRAFT', 'SUBMITTED', 'REJECTED', 'APPROVED', 'PENDING', 'ACTIVE', 'CLOSED', 'AWAITING_PAYMENT', 'SETTLED', 'PAYMENT_FAILED', 'ABANDONED', 'WITHDRAWN')`);
        await queryRunner.query(`ALTER TABLE "products" ALTER COLUMN "status" DROP DEFAULT`);
