...
export class InitSchema1786643208117 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."kyc_verifications_documenttype_enum" AS ENUM('CITIZENSHIP', 'PASSPORT')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."products_status_enum" AS ENUM('DRAFT', 'SUBMITTED', 'REJECTED', 'APPROVED', 'PENDING', 'ACTIVE', 'CLOSED', 'AWAITING_PAYMENT', 'SETTLED', 'PAYMENT_FAILED', 'ABANDONED', 'WITHDRAWN')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."payments_status_enum" AS ENUM('PENDING', 'SUCCESS', 'FAILED', 'EXPIRED')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."payments_deliveryzone_enum" AS ENUM('INSIDE_VALLEY', 'OUTSIDE_VALLEY')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_80a2b377fa57b59dc5c0e138ef" ON "payments" ("productId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_df3c369970714c014a4bcd6b01" ON "payments" ("winnerUserId") `,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_885b048d8480daa62900ddf01e" ON "payments" ("referenceLabel") `,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_4eb1e967f6cc268c5a47d895a7" ON "payments" ("productId") WHERE "status" = 'PENDING'`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_dcfc63d678037d5ed27778bb6b" ON "payments" ("winnerUserId", "status") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_99334eb0755ef43771f9ef80c0" ON "payments" ("productId", "status") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "payments" ADD CONSTRAINT "FK_80a2b377fa57b59dc5c0e138ef3" FOREIGN KEY ("productId") REFERENCES "products"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "payments" ADD CONSTRAINT "FK_df3c369970714c014a4bcd6b01a" FOREIGN KEY ("winnerUserId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "payments" DROP CONSTRAINT "FK_df3c369970714c014a4bcd6b01a"`,
    );
    await queryRunner.query(
      `ALTER TABLE "payments" DROP CONSTRAINT "FK_80a2b377fa57b59dc5c0e138ef3"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_99334eb0755ef43771f9ef80c0"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_dcfc63d678037d5ed27778bb6b"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_4eb1e967f6cc268c5a47d895a7"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_885b048d8480daa62900ddf01e"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_df3c369970714c014a4bcd6b01"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_80a2b377fa57b59dc5c0e138ef"`,
    );
