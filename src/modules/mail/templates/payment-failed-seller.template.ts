import { formatCurrency } from '../utils/mail-format.util';
...
export function paymentFailedSellerTemplate(
  params: PaymentFailedSellerTemplateParams,
  ...
  <div class="wrapper">
    ...
    <div class="body">
      ...
      <div class="summary-row">
        ...
        <span class="value">${formatCurrency(newWinnerBidAmount)}</span>
      </div>
      <p>
