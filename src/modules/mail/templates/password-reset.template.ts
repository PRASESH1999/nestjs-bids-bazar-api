/** Returns the subject and HTML body for the password reset email. */
export function passwordResetTemplate(
  ...
  return {
    subject: 'Reset your password — BidsBazar',
    html: `
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
  <div class="wrapper">
    ...
    <div class="body">
      <p>Hello, ${userName}!</p>
      <p>
        We received a request to reset the password for your BidsBazar account.
