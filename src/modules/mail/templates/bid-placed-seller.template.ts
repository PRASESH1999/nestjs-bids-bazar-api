...
export function bidPlacedSellerTemplate(
  params: BidPlacedSellerTemplateParams,
): { subject: string; html: string } {
  const { sellerName, productTitle, bidAmount, biddingEndsAt, auctionUrl } =
    params;
  return {
  ...
  <div class="wrapper">
    ...
    <div class="body">
      ...
      <div class="info-box">
        ...
        <div class="value">${formatCurrency(bidAmount)}</div>
      </div>
      <div class="info-box">
        <div class="label">Bidding Closes</div>
        <div class="value">${formatDateTime(biddingEndsAt)}</div>
      </div>
